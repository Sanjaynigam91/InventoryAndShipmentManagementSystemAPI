...
namespace InventoryUtility
{
    public class ConstantResources
    {
        ...
        public readonly static string AssignToShipmentBALStart = "ProductAssignToShipment, Bussiness operation execution process started at {'" + timeStamp + "'}";
        ...
        public readonly static string AssignToShipmentBALComplete = "ProductAssignToShipment, Bussiness operation execution process completed at {'" + timeStamp + "'}";
        ...
        public readonly static string GetAllShipmentsBALStart = "GetAllShipmentDetails,Bussiness operation execution process started at {'" + timeStamp + "'}";
        ...
        public readonly static string GetAllShipmentsBAComplete = "GetAllShipmentDetails,Bussiness operation execution process completed at {'" + timeStamp + "'}";
